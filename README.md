...
# Current Version: [3.10.2](https://github.com/Krdan/docker-tsdns/blob/master/Dockerfile)
...
```
docker run -d -p 41144:41144 -v $(pwd)/tsdns_settings.ini:/var/tsdns/tsdns_settings.ini:ro --name tsdns krdan/tsdns:3.10.2
```
